  ...
  return (
    <Container component="main">
      <Paper
        variant="elevation"
        elevation={16}
        sx={{ mt: 3, p: 3, borderRadius: 2, mb: 5 }}
      >
        <Typography variant="h5" textAlign="center">
          About Favorite Map Locations
        </Typography>
        <Divider variant="middle" sx={{ mt: 2, mb: 5 }} />
        <Typography>
        ...
        <List sx={{ listStyleType: "disc", mx: 3 }}>
          <ListRow>
            <b>Elastic Beanstalk/EC2</b> for the backend server, load balancing
            and monitoring
          </ListRow>
          <ListRow>
        ...
        <DependencyTable title="Backend libraries and services:">
          ...
          <DependencyRow
            ...
            name="multer"
          >
            Multipart/form data handling for image file uploads to AWS S3 using{" "}
